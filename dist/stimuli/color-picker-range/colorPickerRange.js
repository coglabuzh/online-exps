...
exports.colorPickerRange = void 0;
 ...
 */
const colorPickerRange = (props) => {
    var _a, _b, _c;
    new webComponent_1.default();
    return (0, utils_1.html) `<color-picker-range
...
exports.colorPickerRange = colorPickerRange;
exports.default = exports.colorPickerRange;
